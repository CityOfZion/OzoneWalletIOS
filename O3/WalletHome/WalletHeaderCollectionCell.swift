    ...
    var data: WalletHeaderCollectionCell.Data? {
        didSet {
            ...
            default:
                ...
                percentChangeLabel.textColor = latestPrice.average >= previousPrice.average ? UserDefaultsManager.theme.positiveGainColor : UserDefaultsManager.theme.negativeLossColor
            }
